...
(function() {
  ...
  Transaction = (function() {
    ...
    function Transaction(_arg) {
      var name;
      this.callback = _arg.callback, name = _arg.name, this.adapter = _arg.adapter, this.id = _arg.id;
      this.name = name;
      this.state = 'initial';
    ...
    Transaction.prototype.create = function() {
      ...
      return Promise.using(this.adapter.getClient(), function(client) {
    ...
    Transaction.prototype.execute = function(client) {
      ...
      return self.openTransaction().then(function() {
        return Request.handle(self, self.callback(self), self.adapter.id);
      })["catch"](function(err) {
        ...
        return setTimeout(function() {
          ...
          str = function(list) {
            return list.map(function(i) {
              var _ref1, _ref2;
              return (_ref1 = (_ref2 = i.name) != null ? _ref2.slice(0, 4) : void 0) != null ? _ref1 : '????';
            }).join(' ');
          };

...
(function() {
  ...
  Transaction = (function() {
    ...
    Transaction.create = function(options) {
      var newTransaction, ref1, type;
      newTransaction = new Transaction(options);
      type = (ref1 = options.type) != null ? ref1 : IMPLICIT;
      return Promise.using(newTransaction.start(type).disposer(function() {
        Transaction.logger.trace("dispose: " + newTransaction.name);
        return Transaction.restartImplicit();
      }), function(res) {
        return res;
      });
    };
    ...
    Transaction.prototype.startImplicit = function() {
      ...
      if (_.size(Transaction.processing) === 0) {
        ...
        this.requestUp = new Request(this.id, this.name);
        return this.requestUp.getTransaction().then(function(transaction) {
          self.requestUp = null;
    ...
    Transaction.restartImplicit = function() {
      var implicit, request, results;
      if (_.size(Transaction.processing) > 0) {
        return;
      }
      implicit = Transaction.implicit.shift();
      if ((implicit != null) && (implicit.requestUp != null)) {
        return implicit.requestUp.fulfill(null);
      } else {
        results = [];
    ...
    Request.handleUnanswered = function(request) {
      ...
      if (!((ref1 = request.deferred) != null ? ref1.promise.isPending() : void 0)) {
        Request.logger.trace("unhandled, not pending:", (ref2 = request.name) != null ? ref2 : '????');
        return;
      }
    ...
    transactionTicker = function(repeat) {
      ...
      tick = function() {
        return setTimeout(function() {
          var implicit, nopen, processing, requests, str;
          str = function(list) {
          ...
          nopen = _.size(Transaction.processing) + Transaction.implicit.length + Transaction.unanswered.length;
          if (nopen > 0) {

...
(function() {
  ...
  Transaction = (function() {
    ...
    Transaction.prototype.complete = function() {
      var implicit, j, len, ref1, ref2, req, request, results, results1;
      ...
      if (implicit != null) {
        ...
        ref1 = Transaction.unanswered;
        results = [];
        for (j = 0, len = ref1.length; j < len; j++) {
          req = ref1[j];
          if (req.implicit === implicit && ((ref2 = req.deferred) != null ? ref2.promise.isPending() : void 0)) {
            results.push(req.fulfill(null));
          } else {
            results.push(void 0);
          }
        }
        ...
        while (Transaction.unanswered.length > 0) {
          ...
          results1.push(request.fulfill(null));
        }
        return results1;
      }
    };
